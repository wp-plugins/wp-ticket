jQuery(document).ready(function($){
	pluginModalHtml =
		    ...
		    + '                 <div class="emd-plugin-modal-panel active" data-panel-id="reasons"><h3><strong>' + plugin_feedback_vars.msg + '</strong></h3><ul id="reasons-list">' + plugin_feedback_vars.reasons + '</ul></div>'
		    + '         </div>'
		    + '         <div class="emd-plugin-modal-footer"><input type="hidden" id="emd-plugin" value="">'
		    + '			<div style="font-size:80%;text-align:left;padding-bottom:5px">' + plugin_feedback_vars.disclaimer + '</div>'
		    + '                 <div>'
	...
	$.fn.setFeedback = function (plugin){
		...
		$pluginModal.on('input propertychange', '.reason-input input', function () {
