( function( $ )
{
	...
	mapField.prototype = {
		...
		{
			this.canvas = this.$container.find( '.emd-mb-map-canvas' )[0];
			this.$coordinate = this.$container.find( '.emd-mb-map-coordinate' );
			this.$findButton = this.$container.find( '.emd-mb-map-goto-address-button' );
	...
	$( function()
	{
		...
		$( '.emd-mb-input' ).on( 'clone', function(params){
			$( '.emd-mb-map-field' ).each( function()
			{
				var field = new mapField( $( this ) );
				field.init();
