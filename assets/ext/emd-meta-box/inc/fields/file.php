...
if ( ! class_exists( 'EMD_MB_File_Field' ) )
{
	class EMD_MB_File_Field extends EMD_MB_Field
	{
		...
		{
			$i18n_title = apply_filters( 'emd_mb_file_upload_string', _x( 'Upload Files', 'file upload', 'emd-plugins' ), $field );
			$i18n_more  = apply_filters( 'emd_mb_file_add_string', _x( '+ Add new file', 'file upload', 'emd-plugins' ), $field );
