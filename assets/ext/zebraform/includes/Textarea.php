...
class Zebra_Form_Textarea extends Zebra_Form_Control
{
    ...
    function __construct($id, $default = '', $attributes = '')
    {
        ...
        $this->set_attributes(
            ...
            array(
                ...
                'id'        =>  $id,
                'rows'      =>  5,
                'cols'      =>  '45',           // used only for passing W3C validation
                'class'     =>  '',
                'type'      =>  'textarea',
                'value'     =>  $default,
    ...
    function toHTML()
    {
        ...
        return '<textarea ' . $this->_render_attributes() . ' style="min-height:150px;">' . (isset($attributes['value']) ? $attributes['value'] : '') . '</textarea>';
