...
if (!function_exists('hidden_begin_html')){
	add_filter( 'rwmb_hidden_begin_html', 'hidden_begin_html' );
	function hidden_begin_html()
	{
		return '<div class="rwmb-label"></div><div class="rwmb-input">';
	}
}
if (!function_exists('hidden_end_html')){
	add_filter( 'rwmb_hidden_end_html', 'hidden_end_html' );
	function hidden_end_html( )
	{
		return '</div>';
	}
}
