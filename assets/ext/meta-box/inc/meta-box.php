...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
		...
		function admin_enqueue_scripts()
		{
			...
			if ( $this->validation )
			{
				wp_enqueue_script( 'jquery-validate', RWMB_URL . '../jvalidate1111/wpas.validate.min.js', array( 'jquery' ), RWMB_VER, true );
				wp_enqueue_script( 'rwmb-validate', RWMB_JS_URL . 'validate.js', array( 'jquery-validate' ), RWMB_VER, true );
				wp_localize_script('rwmb-validate','validate_msg',$jqvalid_msg);
			}
